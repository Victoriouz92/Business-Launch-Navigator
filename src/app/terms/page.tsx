        ...
        <div className="mt-8 space-y-8 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
          <Section title="Какво е Business Launch Navigator">
            <p>
              ...
              България — чеклист със стъпки и наръчници (Наръчници) със статии. Разработва се от Виктор
              Велев (Victor Velev) под името VV Labs — проект на физическо лице, не на регистрирана
              фирма — и е изцяло безплатна през бета фазата.
            </p>
          </Section>

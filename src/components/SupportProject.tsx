  ...
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-6 sm:p-8">
      ...
      <p className="text-sm text-slate-600 dark:text-slate-300 leading-relaxed">
        Business Launch Navigator е и ще остане напълно безплатен за ползване, включително по
        време на бета фазата. Проектът се поддържа в свободното време на автора. Ако ви е бил

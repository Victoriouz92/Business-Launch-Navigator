 ...
 *
 * Основания за регистрация (данни към 14.08.2026, след въвеждането на еврото):
 * - Чл. 96 ЗДДС — задължителна при годишен облагаем оборот в страната над €51,130 за календарната година
 * - Чл. 97а ЗДДС — може да възникне задължителна регистрация още преди да извършиш услугата, при трансгранични B2B услуги в ЕС, без праг по сума
 * - Чл. 99 ЗДДС (ВОП) — може да възникне отделно задължение за регистрация при определени покупки на стоки от фирми в ЕС, дори без да е достигнат общият праг
 * - Дистанционни продажби / OSS — отделен праг от €10,000/година за определени онлайн продажби към крайни клиенти в ЕС
 * - Доброволна регистрация — възможна по всяко време, без праг
 * - Режим за малки предприятия (Глава 21б ЗДДС, от 2026) — при определени условия позволява да не начисляваш ДДС, включително при определени сделки в други държави от ЕС
 */

const MANDATORY_THRESHOLD = 51130 // € годишен оборот в страната за календарната година, чл. 96 ЗДДС
  ...
  return (
    <div className="rounded-xl border-2 border-teal-200 dark:border-teal-800 bg-teal-50/50 dark:bg-teal-950/20 p-5">
      ...
      <p className="text-xs text-slate-600 dark:text-slate-400 mb-4">
        Въведи очаквания годишен облагаем оборот в страната, за да видиш дали регистрацията по общия праг е задължителна.
      </p>
      ...
      <div className="flex flex-col sm:flex-row gap-3 items-end">
        <div className="flex-1 w-full">
          ...
          >
            Годишен облагаем оборот в страната (€)
          </label>
          <input
            id="turnover-input"
            type="number"
      ...
      <div className="mt-4 space-y-2">
        ...
        <ul className="space-y-1.5 text-xs text-slate-600 dark:text-slate-400">
          <li>
            <span className="font-medium text-slate-800 dark:text-slate-200">Чл. 97а</span> — при трансгранични B2B услуги в ЕС може да възникне задължителна регистрация още преди да извършиш услугата, без праг по сума.
          </li>
          <li>
            <span className="font-medium text-slate-800 dark:text-slate-200">Чл. 99 (ВОП)</span> — при определени покупки на стоки от фирми в други държави от ЕС може да възникне отделно задължение за регистрация, дори да не си достигнал общия праг.
          </li>
          <li>
            <span className="font-medium text-slate-800 dark:text-slate-200">Дистанционни продажби / OSS</span> — при определени онлайн продажби към крайни клиенти в ЕС има отделен праг от €10 000/година, след който се прилагат специални правила.
          </li>
          <li>
          ...
          <li>
            <span className="font-medium text-slate-800 dark:text-slate-200">Режим за малки предприятия (Глава 21б, от 2026 г.)</span> — при определени условия позволява да не начисляваш ДДС, включително при определени сделки в други държави от ЕС.
          </li>
        </ul>
      </div>
      ...
      <p className="mt-3 text-xs text-slate-400 dark:text-slate-500">
        * Информацията е образователна, не представлява данъчен съвет. Данните са актуални към 14 август 2026 г. Консултирай се със счетоводител за твоя конкретен случай.
      </p>
    </div>
  )
}
